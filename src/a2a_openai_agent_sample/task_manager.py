# With minor fixes to import statements, this is a copy of
#   https://github.com/google/A2A/blob/72b60eb6e6f28284a1d7b3723f4f59057153e7c4/samples/python/agents/langgraph/task_manager.py
...
from .agent import OpenAICurrencyAgent
...
class AgentTaskManager(InMemoryTaskManager):
    ...
    def _validate_request(
        ...
        if not utils.are_modalities_compatible(
            ...
            OpenAICurrencyAgent.SUPPORTED_CONTENT_TYPES,
        ):
            logger.warning(
